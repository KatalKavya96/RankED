...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => setStreak(calculateStreak()), 2000);
    ...
    <section className="w-full  bg-[#242424]  border-b border-[#2b2b2b]">
      <div className="flex justify-between items-center px-[3vw] border border-black bg-[#121212] text-white/80">
        <div className="flex items-center gap-10">
          <img
            className="h-20 w-22"
            src="https://i.imgur.com/OpOueJv.png"
            alt="RankED Logo"
          />

          <div className="w-15 font-medium hover:bg-white/15 p-2 rounded-2xl flex items-center justify-center cursor-pointer">
            Play
          </div>

          {/* NEW: DarkHome button */}
          <div
            onClick={() => navigate("/darkhome")}
          ...
          <div
            onClick={() => navigate("/")}
            className="w-25 font-medium hover:bg-white/15 p-2 rounded-2xl flex items-center justify-center cursor-pointer"
          >
            Problems
          </div>
        </div>
        ...
        <div className="flex items-center gap-10">
          ...
          <div className="cursor-pointer w-10 hover:bg-white/15 p-2 rounded-2xl flex items-center justify-center">
            ...
            >
              ...
              />
              <circle cx="16.1" cy="5.9" r="3" fill="#F63636"></circle>
            </svg>
          </div>
          ...
          <div
            ...
            className="cursor-pointer w-16 hover:bg-white/15 font-medium p-2 rounded-2xl flex items-center justify-center"
          >
            Profile
          </div>
        </div>
