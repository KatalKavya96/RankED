            ...
            {filteredChapters.map((ele) => {
              ...
              return (
                <div
                  ...
                  className="h-auto w-full border-r-4 border-r-blue-500 border-2 border-black/60 mt-5 rounded-lg p-3 hover:scale-102 transition duration-100 bg-white active:scale-103 cursor-pointer"
                >
