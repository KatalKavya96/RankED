...
const PhysicsQ = () => {
  ...
  const chaptersP = [
    { name: "Mathematics in Physics", ques: 116 },
    { name: "Units and Dimensions", ques: 119 },
    { name: "Motion in One Dimension", ques: 161 },
    { name: "Motion in Two Dimensions", ques: 113 },
    { name: "Laws of Motion", ques: 186 },
    { name: "Work Power Energy", ques: 116 },
    { name: "Center of Mass, Momentum and Collision", ques: 121 },
    { name: "Rotational Motion", ques: 234 },
    { name: "Gravitation", ques: 205 },
    { name: "Mechanical Properties of Solids", ques: 95 },
    { name: "Mechanical Properties of Fluids", ques: 163 },
    { name: "Thermal Properties of Matter", ques: 125 },
    { name: "Thermodynamics", ques: 199 },
    { name: "Kinetic Theory of Gases", ques: 151 },
    { name: "Oscillations", ques: 172 },
    { name: "Waves and Sound", ques: 161 },
    { name: "Electrostatics", ques: 260 },
    { name: "Capacitance", ques: 157 },
    { name: "Current Electricity", ques: 365 },
    { name: "Magnetic Properties of Matter", ques: 73 },
    { name: "Magnetic Effects of Current", ques: 248 },
    { name: "Electromagnetic Induction", ques: 131 },
    { name: "Alternating Current", ques: 177 },
    { name: "Electromagnetic Waves", ques: 142 },
    { name: "Ray Optics", ques: 247 },
    { name: "Wave Optics", ques: 155 },
    { name: "Dual Nature of Matter", ques: 183 },
    { name: "Atomic Physics", ques: 138 },
    { name: "Nuclear Physics", ques: 146 },
    { name: "Semiconductors", ques: 219 },
    { name: "Experimental Physics", ques: 62 },
  ];

  const totalSubjectQuestions = chaptersP.reduce((sum, ch) => sum + ch.ques, 0);
  ...
  useEffect(() => {
    const totalQues = chaptersP.reduce((acc, ch) => acc + ch.ques, 0);
    const tempMap = {};
    chaptersP.forEach((ch) => {
  ...
  const filteredChapters = [...chaptersP]
        ...
        <div className="flex-1 mx-8">
          {filteredChapters.map((ele) => {
            ...
            return (
              <div
                key={ele.name}
                onClick={() => navigate(`/physics/${encodeURIComponent(ele.name)}`)}
                className="h-auto w-full border-r-4 border-r-green-500 border-1 shadow-sm border-black/40 mt-5 rounded-lg p-3 hover:scale-102 transition duration-100 bg-white active:scale-103 cursor-pointer"
              >
                ...
                <div className="w-full bg-gray-300 rounded-full h-2.5 overflow-hidden">
                  <div
                    className="bg-green-500 h-2.5 rounded-full animate-grow transition-all duration-1000"
                    style={{ width: `${percent}%` }}
                  ></div>
                </div>
