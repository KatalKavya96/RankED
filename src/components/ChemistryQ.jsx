          ...
          {filteredChapters.map((ele) => {
            ...
            return (
              <div
                ...
                className="h-auto w-full border-r-4 border-r-orange-500 border-1 shadow-sm border-black/40 mt-5 rounded-lg p-3 hover:scale-102 transition duration-100 bg-white active:scale-103 cursor-pointer"
              >
