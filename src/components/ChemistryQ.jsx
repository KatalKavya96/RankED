  ...
  return (
    <>
      ...
      <section className="mt-35">
        {chaptersC.map((ele) => {
          ...
          return (
            <div
              ...
              className="h-auto w-[50vw] border-r-4 border-r-orange-500 border-2 border-black/60 mt-12 ml-[11vw] rounded-lg p-3 hover:scale-102 transition duration-100 bg-white active:scale-103 cursor-pointer"
                        >
        ...
        <div className="h-30 w-85 border-2 border-black/60 border-r-4 border-r-orange-500 fixed top-35 right-25 rounded-lg p-5 bg-white">
          <h1 className="text-3xl font-medium">Chemistry</h1>
          <p className="text-lg font-light">24 Chapters, 5000+ Questions</p>
        </div>
      </section>
    </>
  );
